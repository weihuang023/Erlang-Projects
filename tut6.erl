...
list_max([], Res) ->                                              % result will end when list is empty on the head
    Res;             
...
list_max([Head|Rest], Result_so_far)  ->                          % (Rest,Head) -> ([Head | Rest], Result_so_far) 
                                                                  % result so far is head from the provious list_max                                                                  % ([],Res) when list is 
